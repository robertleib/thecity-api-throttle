...
Gem::Specification.new do |s|
  ...
  s.homepage = "http://github.com/robertleib/thecity-api-throttle"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rack-throttle>, [">= 0"])
      ...
      s.add_dependency(%q<rack-throttle>, [">= 0"])
